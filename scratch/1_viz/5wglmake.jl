...
# ╔═╡ 032a774b-b421-4f4e-a0d7-510d7219ce3a
using WGLMakie, GeometryBasics, LinearAlgebra


# ╔═╡ 562df17e-6f69-11f0-1b91-5fe169816d5f
using WGLMaie:: Figure

# ╔═╡ 424a08d5-99da-4c1d-a170-cdbb7970ea35
...
# ╔═╡ b33f2b0f-2f66-4eaf-bfc2-5c9551168418
ex = Point3f(1,0,0)

# ╔═╡ 379a9f7f-c2c8-461c-8f6a-7aba213efd8b
ey = Point3f(0,1,0)

# ╔═╡ c4afbd22-ff7d-413e-baa3-af2854b55bef
ez = Point3f(0,0,1)

# ╔═╡ 68346e0c-7f37-490e-81dc-c0f25977f576
fig = Figure()

# Set up Scene shown by a camera

# ╔═╡ 8b0b28ff-5748-4f07-9f2d-2dcfadb00fdb
scene = LScene(fig[1, 1])

# ╔═╡ d333ac55-e02b-456f-8d0e-d63c19779f8c
cc = Makie.Camera3D(scene.scene, projectiontype = Makie.Perspective, center = false)

# ╔═╡ 81ebe284-f952-467f-95fd-f03e75a59ef6
linesegments!(scene, Rect3f(Point3f(-1), Vec3f(2)), color = :black)

# ╔═╡ a37bb660-efac-404f-8e7e-4ccc38768c59
linesegments!(scene,
    [-ex, ex, -ey, ey, -ez, ez],
    color = [:red, :red, :green, :green, :blue, :blue]
)

# ╔═╡ ad8e05cf-9249-4fc5-8c83-7f16f864f24a
center!(scene.scene)

# ╔═╡ 263fb08b-3e66-4dc1-ad86-afe771170567
cam = scene.scene.camera

# ╔═╡ 9bd5d51a-f13f-4997-85fe-7132ce6d6ca9
eyeposition = cc.eyeposition

# ╔═╡ 573b02b4-0178-41b8-b19a-7558c86f349d
lookat = cc.lookat

# ╔═╡ 418f0981-f8f0-4060-806c-3d9aebdcea60
frustum = map(pv -> frustum_snapshot(cam), cam.projectionview)

# Set up scene visualizing the cameras view

# ╔═╡ 512ae85a-748d-4cf4-a577-736a3b529697
scene2 = LScene(fig[1, 2])

# ╔═╡ 23985385-df52-4879-adca-b03722cf9238
_cc = Makie.Camera3D(scene2.scene, projectiontype = Makie.Orthographic, center = false)

# ╔═╡ 587c5178-5192-4e16-8ae6-20c6bbe182d5
lines!(scene, frustum, color = :blue, linestyle = :dot)

# ╔═╡ 64176f1a-39ed-4818-8d26-dfaea753a8f4
scatter!(scene, eyeposition, color = :black)

# ╔═╡ c02b2e09-b3fd-454c-b2ea-75751d2006c4
scatter!(scene, lookat, color = :black)

# ╔═╡ c1333453-adde-4c38-b4ce-a42a9681819f
linesegments!(scene2,
    [-ex, ex, -ey, ey, -ez, ez],
    color = [:red, :red, :green, :green, :blue, :blue]
)

# ╔═╡ 9b81bb7f-41b1-4fea-a47c-168ec985ef87
linesegments!(scene2, Rect3f(Point3f(-1), Vec3f(2)), color = :black)

# Tweak initial camera position

# ╔═╡ 26e23117-2bb8-4f0b-85cf-f32501096856
update_cam!(scene2.scene, Vec3f(4.5, 2.5, 3.5), Vec3f(0))

# ╔═╡ ad7a1a7e-33a8-41a8-8402-c490ae3e71bb
update_cam!(scene2.scene, Vec3f(6, 8, 5), Vec3f(0))

# ╔═╡ f3984646-6e8c-4afe-952b-3b1f67b5ac84
display(fig)

# ╔═╡ 70a0b2a3-f85e-4f45-bdbf-7e9b23bb2754
sleep(10)

# ╔═╡ b3b296cc-1447-400d-a781-260f4956ab7e
...
manifest_format = "2.0"
project_hash = "75c47d1e7bb8e7ab1efd0300bf1f0739bdea74bf"
